...
const TextContent = () => {
  return (
    <section className="mx-auto max-w-7xl px-7 lg:py-2 text-black font-satoshi">
      
      {/* Top paragraph */}
      <p className="text-[15px] lg:text-[27px] lg:w-[1240px] font-[500]">
      ...
      {/* Big bold question */}
      <h2 className="my-9 px-4 text-center text-[25px] lg:text-[40px] lg:px-60  font-[900] ">
      ...
      {/* Bottom paragraph */}
      <p className="text-[15px] w-[385px] lg:text-[27px] lg:w-[1240px] font-[500]">
